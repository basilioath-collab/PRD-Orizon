...
Aplicação de planejamento e capacidade em React, Next.js e TypeScript. Mantém os fluxos de armazenamento local, sincronização por arquivos e a publicação em `https://basilioath-collab.github.io/PRD-Orizon/`.
...
O ambiente local usa o mesmo caminho da publicação: `http://localhost:3000/PRD-Orizon/`.
